...
import (
	...
	petstorev1alpha1 "github.com/odogwuVal/kubernetes-extension/blob/main/petstore-operator/api/v1alpha1"
...
func (r *PetReconciler) ReconcileNormal(ctx context.Context, pet *petstorev1alpha1.Pet) (ctrl.Result, error) {
...
func findPetInStore(ctx context.Context, psc *psclient.Client, pet *petstorev1alpha1.Pet) (*psclient.Pet, error) {
...
func createPetInStore(ctx context.Context, pet *petstorev1alpha1.Pet, psc *psclient.Client) error {
	pbPet := &pb.Pet{
		Name:     pet.Spec.Name,
...
func updatePetInStore(ctx context.Context, psc *psclient.Client, pet *petstorev1alpha1.Pet, pbPet *pb.Pet) error {
...
func petTypeToProtoPetType(petType petstorev1alpha1.PetType) pb.PetType {
	switch petType {
	case petstorev1alpha1.DogPetType:
		return pb.PetType_PTCanine
	case petstorev1alpha1.CatPetType:
		return pb.PetType_PTFeline
	case petstorev1alpha1.BirdPetType:
